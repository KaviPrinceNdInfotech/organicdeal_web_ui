...
function Category() {
  ...
  return (
    <>
     <section class="category2 section-mt-space">
                      ...
                      <svg enable-background="new 0 0 64 64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          ...
                          <path
                            ...
                            fill="#c18e59" />
                          <ellipse cx="32" cy="8" fill="#db9b7c" rx="19.147" ry="6" />
                          <path
                          ...
                          <path
                            ...
                            fill="#c66b60" />
                          <ellipse cx="32" cy="8" fill="#c66b60" rx="12.093" ry="2" />
                          <path
                          ...
                          <g fill="#674025">
                            <path d="" />
                            <path
                              d="m19.005 31.501c-.659 3.178-.998 6.436-.998 9.73v.385c0 .53.212 1.039.59 1.414l.131.13c2.257-.808 4.391-1.87 6.376-3.145-2.348-2.631-4.396-5.482-6.099-8.514z" />
                          </g>
                          <path
